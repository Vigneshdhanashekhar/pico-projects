...
// ============================================================================
void swap2numxthirdvar(int *num1_inside_func,int *num2_inside_func);
...
void process_command(char *cmd) {
    ...
    //Adding Else if condition to handle Swap command.
    else if (strcmp(cmd, "swap") == 0 || strcmp(cmd, "SWAP") == 0 || strcmp(cmd, "Swap") == 0) 
    {
...
void swap2numxthirdvar(int *num1_inside_func,int *num2_inside_func){
    *num1_inside_func = *num1_inside_func + *num2_inside_func;
    *num2_inside_func = *num1_inside_func - *num2_inside_func;
    *num1_inside_func = *num1_inside_func - *num2_inside_func;
}
